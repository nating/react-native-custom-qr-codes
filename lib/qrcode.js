...
QRCode.prototype.svg = function(opt) {
  ...
  //This works when creating a big black triangle
...
function getShapeOne(x,y,options,modules,mod_matrix){
  ...
  switch(options.style){
    case 'square':
      return '<rect transform="rotate('+orientation+' '+xsize/2+' '+ysize/2+')" x="' + px + '" y="' + py + '" width="' + xsize + '" height="' + ysize + '" style="fill:' + options.color + ';shape-rendering:crispEdges;"/>' + EOL;
    case 'circle':
      return '<rect transform="rotate('+orientation+' '+xsize/2+' '+ysize/2+')" rx="'+xsize+'" x="' + px + '" y="' + py + '" width="' + xsize + '" height="' + ysize + '" style="fill:' + options.color + ';shape-rendering:crispEdges;"/>' + EOL;
    case 'triangle':
