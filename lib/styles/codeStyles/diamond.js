...
export function drawDiamondPiece(x,y,modules,pieceProperties,props){
  ...
  return (<G key={'d:'+px+':'+py} x={px+xsize/2} y={py+ysize/2} width={xsize} height={ysize}><Rect key={'r:'+px+':'+py} x={-xsize/2} y={-ysize/2} width={xsize} height={ysize} rotate={45} fill={props.color} /></G>);
}
