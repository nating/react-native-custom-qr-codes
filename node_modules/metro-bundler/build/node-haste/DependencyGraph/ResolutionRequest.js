...
class ResolutionRequest {
  ...
  constructor(options) {this._doesFileExist = filePath => this._options.hasteFS.exists(filePath);
  ...
  ext)
  {var _options =
    this._options;const platform = _options.platform,preferNativePlatform = _options.preferNativePlatform;
    if (platform != null) {
  ...
  /**
     ...
     */
  _loadAsPackage(packageJsonPath) {
  ...
  }}ResolutionRequest.EMPTY_MODULE = require.resolve('./assets/empty-module.js');
