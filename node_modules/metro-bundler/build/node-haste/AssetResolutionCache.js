...
class AssetResolutionCache {
  ...
  constructor(options) {this.
    ...
    _findAssets = dirPath => {
      ...
      return results;
    };this._assetsByDirPath = new MapWithDefaults(this._findAssets);this._opts = options;} /**
                                                                                            ...
                                                                                            * more error-prone.
                                                                                            */clear() {this._assetsByDirPath.clear();} /**
                                                                                                                                        ...
                                                                                                                                        */resolve(dirPath, assetName, platform) {const results = this._assetsByDirPath.get(dirPath);const assets = results.get(assetName);if (assets == null) {return EMPTY_ARRAY;}return assets.filter(asset => asset.platform == null || asset.platform === platform).map(asset => asset.fileName);} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                        */_isValidAsset(assetData) {return this._opts.assetExtensions.has(assetData.type);}} /**
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              * Used instead of `MapWithDefaults` so that we don't create empty arrays
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              * anymore once the index is built.
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              */function getWithDefaultArray(map, key) {let el = map.get(key);if (el != null) {return el;
  }
  el = [];
  map.set(key, el);
  return el;
